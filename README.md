...
2. **Download structures** — fetches AlphaFold CIF models and PAE files for each protein (will be a little over 2gb) by iterating over all UniProt IDs found in the tsv file generated by step 1
